...
o2.footer = {
  ...
  resizer: function resizer() {
    ...
    this.windowEl.resize(function () {
      _this.footerDropdownes.removeAttr('style');

      _this.footerTitle.removeClass('active');
    });
  }
};
o2.gDatePicker = {
...
o2.header = {
  burgerClickHandler: function burgerClickHandler(instance) {
    $(instance).toggleClass('active');
